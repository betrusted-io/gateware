...
{}
        ...
        platform.add_platform_command("set_multicycle_path 2 -setup -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=ra_const)
        platform.add_platform_command("set_multicycle_path 1 -hold -end -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=ra_const)
        platform.add_platform_command("set_multicycle_path 2 -setup -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=rb_const)
        platform.add_platform_command("set_multicycle_path 1 -hold -end -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=rb_const)
        platform.add_platform_command("set_multicycle_path 2 -setup -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=self.ra_const_rom.adr)
        platform.add_platform_command("set_multicycle_path 1 -hold -end -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=self.ra_const_rom.adr)
        platform.add_platform_command("set_multicycle_path 2 -setup -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=self.rb_const_rom.adr)
        platform.add_platform_command("set_multicycle_path 1 -hold -end -from [get_clocks sys_clk] -to [get_clocks sys_clk] -through [get_nets {net}*]", net=self.rb_const_rom.adr)
