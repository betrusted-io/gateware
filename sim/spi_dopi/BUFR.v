...
`endif
    ...
    localparam SIM_BUFFER_DELAY = 4674.0;  // 725.0 for BUFR
  ...
  endgenerate
    ...
    assign #SIM_BUFFER_DELAY o_out = (period_toggle == 0) ? i_in : o_out_divide;
